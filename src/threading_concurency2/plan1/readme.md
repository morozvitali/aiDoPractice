...
🎯 Мета модуля:
Зрозуміти, як створюються потоки, як вони працюють у JVM, що таке планувальник, join(), sleep() і daemon, а також відчути перші прояви непередбачуваності при паралельному виконанні.
