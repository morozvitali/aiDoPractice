...
^	Початок рядка
[A-Z]	Речення має починатися з великої літери
[^\\d]*	Не містить цифр (\\d означає "цифра", [^...] означає "жодної такої")
[\\.?!]$	Закінчується крапкою (.), знаком оклику (!) або знаком питання (?)
$	Кінець рядка
