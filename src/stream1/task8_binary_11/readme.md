...
-
📋 Умова:
Реалізуй метод countBits(int n),
який повертає кількість одиниць 
...
-
📋 Умова:
Оброби найбільше 32-бітове число 
Integer.MAX_VALUE.
Скільки в ньому 1?
...
🧩 ЗАДАЧА 5: Порівняння чисел за кількістю 1
-
...
-
📋 Умова:
Знайди всі числа від 0 до N, 
у яких парна кількість одиниць.
