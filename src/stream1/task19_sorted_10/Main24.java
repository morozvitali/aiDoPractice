...
public class Main24 {
    ...
    public List <Integer> practice5 () {
        ...
        return nums.stream().sorted(Comparator.comparingInt((Integer n)->(n%2)).thenComparing(n->n)).toList();
    }
    ...
    public List <Integer> practice9 () {
        ...
        return numbers.stream().sorted(Comparator.comparingInt((Integer a)->a%2).thenComparing(Comparator.reverseOrder())).toList();
    }
