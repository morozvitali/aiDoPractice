...
🔥 Завдання #: Генерація та конвертація
...
🟡 Задача 3: Квадрат кожної цифри (square every digit)
...
✅ Задача 5: Залишити тільки парні цифри
Умова:
...
✅ Задача 6: Перетвори кожну цифру в зірочки
Умова:
...
✅ Задача 7: Переверни цифри в числі
Умова:
...
✅ Задача 8: Заміни кожну цифру на її квадрат, 
якщо вона непарна
Умова:
...
✅ Задача 9: Помнож кожну цифру на її позицію
(зліва направо, з 1)
Умова:
