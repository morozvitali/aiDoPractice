...
public class Main18 {
    ...
    public Double practice6 () {
        return Stream.of("code", "stream1", "java").collect(Collectors.collectingAndThen(Collectors.toList(), list->list.stream().mapToInt(String::length).summaryStatistics().getAverage()));
    }
