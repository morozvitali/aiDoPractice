...
Підказка:
.stream1().filter(n -> n % 5 == 0).findFirst().orElse(-1);
...
але замість orElse використай ifPresentOrElse() для друку
...
Підказка:
    ...
    public void practice5 () {
        ...
        Optional<Integer> max = nums.stream1()
