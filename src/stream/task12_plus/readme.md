...
✅ Задача 4: Залишити тільки парні цифри
Умова:
...
✅ Задача 5: Перетвори кожну цифру в зірочки
Умова:
...
✅ Задача 6: Переверни цифри в числі
Умова:
...
✅ Задача 7: Заміни кожну цифру на її квадрат, якщо вона непарна
Умова:
...
✅ Задача 8: Рахуємо кількість цифр у числі
Умова:
...
✅ Задача 9: Помнож кожну цифру на її позицію (зліва направо, з 1)
Умова:
...
✅ Задача 10: Заміни кожну цифру на її абсолютну різницю з 5
Умова:
987 → 4 3 2 → "432"
...
✅ Задача 11: Заміни кожну цифру на "X", якщо вона > 5, і "O" інакше
Умова:
67894 → XXOXO
