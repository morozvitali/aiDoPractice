...
🧩 ЗАДАЧА 1: Базова
📋 Умова:
Реалізуй метод countBits(int n), який повертає кількість одиниць у двійковому представленні числа.
...
🧩 ЗАДАЧА 2: Через бітову операцію
📋 Умова:
...
🧩 ЗАДАЧА 3: Перевірка на максимальне число
📋 Умова:
...
🧩 ЗАДАЧА 4: Порівняння двох чисел за кількістю 1
📋 Умова:
...
🧩 ЗАДАЧА 5: Сума всіх бітів у масиві
📋 Умова:
...
→ 5
🧩 ЗАДАЧА 6: Перше число з рівно N одиницями
📋 Умова:
...
🧩 ЗАДАЧА 7: Числа з парною кількістю 1
📋 Умова:
...
🧩 ЗАДАЧА 8: Паліндром у бінарному записі
📋 Умова:
Число називається бінарним паліндромом, якщо його бінарне представлення читається однаково зліва направо і навпаки.
...
🧩 ЗАДАЧА 9: Найменше число з заданою кількістю 1
📋 Умова:
...
🧩 ЗАДАЧА 10: Чи є число степенем двійки?
📋 Умова:
