...
Завдання 2
-
Умова: Створіть StringBuilder зі словом "Java", вставте в середину " cool " і виведіть результат.
-
...
.insert(index, text) вставляє текст у задану позицію, не видаляючи наявний.

У нашому випадку "Java" → "Ja" + " cool " + "va".

Завдання 3
-
Умова: Є StringBuilder зі словом "abcdef". Видаліть з нього літери з індексів 2 по 4 включно.
-
...
Якщо видаляти зліва направо, індекси зміщуються, і ми пропускаємо символи.
