...
✅ Завдання 1 (🧠 ускладнено): Знайди найдовше слово, яке містить літеру "e" або "E", і його довжину
...
✅ Завдання 2 (🧠 ускладнено): Порахуй кількість унікальних парних чисел, а також поверни summaryStatistics() по ним
...
.distinct()
.summaryStatistics()
✅ Завдання 3 (🧠 ускладнено): Збери слова з парною довжиною в нижньому регістрі і поверни також загальну кількість символів
...
✅ Завдання 4 (🧠 ускладнено): Побудуй Map<Character, IntSummaryStatistics> — для перших літер слів довших за 4 символи
...
✅ Завдання 5 (🧠 ускладнено): Створи Map<String, Integer> для слів, у яких більше 1 голосної та довжина > 3
...
🆕 Додаткові 5 завдань:
✅ Завдання 6: Обчисли середню довжину всіх слів, які містять хоча б одну голосну
...
✅ Завдання 7: Знайди найкоротше слово, яке починається з голосної
...
✅ Завдання 9: Порахуй, скільки разів кожна голосна зустрічається у всіх словах
...
✅ Завдання 10: Знайди IntSummaryStatistics по довжині всіх слів, які мають щонайменше 2 однакові літери
...
✅ Завдання 12: Побудуй Map<Boolean, List<String>> — поділи слова, які починаються з великої літери
...
✅ Завдання 13: Побудуй Map<String, Long> — підрахуй, скільки разів зустрічається кожне слово (регістр не враховуємо)
...
✅ Завдання 14: Порахуй кількість усіх символів у словах довжиною від 4 до 6, та виведи summaryStatistics
...
.filter(w -> "aeiou".chars().anyMatch(c -> w.chars().filter(ch -> ch == c).count() >= 2))
.findFirst()
.orElse("not found")
🧠 Хочеш бонусний виклик?
🔹 Згенеруй List<List<Integer>> — і зроби задачу з flatMap
🔹 Створи утиліту normalize(String) → яка чистить слова і приводить до нижнього регістру
🔹 Зроби Map<Char, Double> — середня довжина слів на кожну початкову літеру

🚀 Готовий до наступного раунду або хочеш зібрати всі задачі в один клас із main() і запуском як тренажера?
