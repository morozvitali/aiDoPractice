...
📥 Вхід: ["apple", "car", "banana", "hi", "cherry"] 📤 Вихід: ["apple", "banana", "cherry"] — 
...
📋 Умова:
Знайди найдовше слово, відсортувавши список за довжиною за спаданням і повернувши перше (найдовше) через get(0)
...
📋 Умова:
Групуй слова за першою літерою. Результат — Map<Character, List<String>>, 
яка є незмінною.

📥 Вхід: ["apple", "ant", "banana", "bat", "car"]📤 Вихід:
...
✅ Завдання 9: Список непарних чисел → перетвори у строку
📋 Умова:
