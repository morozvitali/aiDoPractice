...
✅ Задача 5: Кількість повторів символів (літери та цифри)
📋 Умова:
...
🧪 Задача 6: Найчастіше слово у тексті
📋 Умова:
...
🧪 Задача 7: Сума чисел з однаковими останніми цифрами
📋 Умова:
...
🧪 Задача 8: Порахувати довжини слів
📋 Умова:
...
🧪 Задача 9: Перша літера → список слів
📋 Умова:
...
🧪 Задача 10: Найчастіше число в масиві (інтеграція з entrySet)
...
✅ Задача 11: Порахувати кількість цифр у рядку
📋 Умова:
...
✅ Задача 12: Найдовше слово для кожної довжини
📋 Умова:
Є список слів. Знайди для кожної довжини слово, 
яке є найдовшим (а якщо рівні — перше за порядком).
...
✅ Задача 13: Групування чисел по парності
📋 Умова:
...
✅ Задача 14: Порахувати середнє значення по групах
📋 Умова:
...
✅ Задача 15: Найчастіший перший символ слова
📋 Умова:
...
✅ Задача 16: Сортування Map за значенням
📋 Умова:
...
✅ Задача 17: Сума чисел, отриманих з рядків
📋 Умова:
...
✅ Задача 18: Знайти слово з максимальною 
кількістю голосних
📋 Умова:
...
✅ Задача 19: Чи всі значення в Map парні?
📋 Умова:
